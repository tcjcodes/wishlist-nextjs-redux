...
// withRedux()
// automatically connect Component to redux and wrap with react-redux Provider
export default (...args) => (Component) => {
  ...
  ComponentWithRedux.getInitialProps = async (props = {}) => {
    ...
    // Run page getInitialProps with store and isServer and other props
    ...
    return {
      store,
      initialState: store.getState(), // pass from server to client
      initialProps
    }
  }
